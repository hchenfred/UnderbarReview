(function() {
  ...
  _.reject = function(collection, test) {
    ...
    return _.filter(collection, function(val, key, collection) {
      return !test(val);
    });
  };
  ...
  _.shuffle = function(array) {
    ...
    // randomNumber = Math.random(0-array.length)
    ...
    for (var i = 0; i < result.length; i++) {
      var randomNumber = getRandomNum(i, result.length-1);
      swap(i, randomNumber, result);
    }

    return result;
    /*var result = [];
    if (result[getRandomNum(0, array.length-1)] === undefined) {
      result.push(result[getRandomNum(0, array.length-1)]);
    } 
    console.log(result);  
  ...
  _.invoke = function(collection, functionOrKey, args) {
    if (typeof functionOrKey === 'function') {
      ...
      return _.map(collection, function(val, key, collection) {
        ...
        //val.functionOrKey.apply(val, args);
      })
    }
  };
  ...
  _.sortBy = function(collection, iterator) {
    ...
    if (typeof iterator === 'function') {
      var newArray = _.map(collection, function(element) {
